---
title: "percentile"
description: "Returns the BigInt at a given percentile of an array."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# percentile (for `BigInt`s) <Badge color="#c85a3e">es-toolkit</Badge>
...
<Field name="arr" type="readonly bigint[]" required>
The array of `BigInt`s to calculate the percentile of.
</Field>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/bigint/percentile.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
