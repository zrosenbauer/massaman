---
title: "median"
description: "Returns the middle value of an array of BigInts."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# median (for `BigInt`s) <Badge color="#c85a3e">es-toolkit</Badge>
...
The array of `BigInt`s to calculate the median of.
</Field>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/bigint/median.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
