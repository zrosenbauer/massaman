---
title: "min"
description: "Returns the smallest BigInt in an array."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# min (for `BigInt`s) <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/bigint/min.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
