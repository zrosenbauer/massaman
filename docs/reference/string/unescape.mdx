---
title: "unescape"
description: "Converts HTML entity characters to their original characters."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# unescape <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/string/unescape.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
