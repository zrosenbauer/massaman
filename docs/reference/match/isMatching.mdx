---
title: isMatching
description: "A predicate form of match — returns true/false instead of a value, and narrows types in the truthy branch."
---

import { Badge } from '@ciderpress/ui/theme'

# isMatching <Badge color="#c85a3e">ts-pattern</Badge>
