---
title: "TimeoutError"
description: "An error class representing an operation that has timed out."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# TimeoutError <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/error/TimeoutError.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
