---
title: "flow"
description: "Performs left-to-right function composition, returning a reusable function instead of running immediately."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# flow (Functional Programming) <Badge color="#c85a3e">es-toolkit</Badge>
...
<Field name="functions" type="Array&lt;(...args: any[]) =&gt; any&gt;" required>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/fp/reference/flow.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
