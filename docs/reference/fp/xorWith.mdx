---
title: "xorWith"
description: "Creates a function that returns the symmetric difference using a custom equality function."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# xorWith (Functional Programming) <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/fp/reference/xorWith.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
