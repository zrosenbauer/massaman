---
title: "Mutex"
description: "Ensures that multiple asynchronous tasks do not execute simultaneously."
---

import { Badge } from '@ciderpress/ui/theme'

# Mutex <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/promise/Mutex.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
