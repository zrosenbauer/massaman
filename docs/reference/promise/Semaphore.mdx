---
title: "Semaphore"
description: "Limits the number of asynchronous tasks that can execute simultaneously."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# Semaphore <Badge color="#c85a3e">es-toolkit</Badge>
...
<Field name="capacity" type="number" required>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/promise/Semaphore.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
