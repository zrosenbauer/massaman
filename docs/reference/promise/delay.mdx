---
title: "delay"
description: "Delays code execution for a specified amount of time."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# delay <Badge color="#c85a3e">es-toolkit</Badge>
...
<Field name="options" type="DelayOptions">
Delay options.
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/promise/delay.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
