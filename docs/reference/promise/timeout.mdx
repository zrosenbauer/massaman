---
title: "timeout"
description: "Returns a Promise that throws a TimeoutError after the specified time."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# timeout <Badge color="#c85a3e">es-toolkit</Badge>
...
<Field name="options" type="TimeoutOptions">
Timeout options.
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/promise/timeout.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
