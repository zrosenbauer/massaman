---
title: "limitAsync"
description: "Creates a new function that limits the maximum number of concurrent executions of an async function."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# limitAsync <Badge color="#c85a3e">es-toolkit</Badge>
...
<Field name="callback" type="F extends (...args: any[]) =&gt; Promise&lt;any&gt;" required>
The async function to limit concurrent executions for.
</Field>

<Field name="concurrency" type="number" required>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/promise/limitAsync.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
