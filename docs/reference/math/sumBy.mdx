---
title: "sumBy"
description: "Calculates the sum of array elements using a transformation function."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# sumBy <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/math/sumBy.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
