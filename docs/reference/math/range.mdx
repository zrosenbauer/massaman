---
title: "range"
description: "Creates an array of numbers within a specified range and step."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# range <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/math/range.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
