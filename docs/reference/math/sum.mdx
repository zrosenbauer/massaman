---
title: "sum"
description: "Returns the sum of all elements in an array of numbers."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# sum <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/math/sum.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
