---
title: "medianBy"
description: "Calculates the median of an array by applying the getValue function to each element."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# medianBy <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/math/medianBy.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
