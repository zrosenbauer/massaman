---
title: "unary"
description: "Creates a new function that limits a function to accept only the first parameter."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# unary <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/function/unary.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
