---
title: "debounce"
description: "Creates a debounced function that delays the invocation of a function."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# debounce <Badge color="#c85a3e">es-toolkit</Badge>
...
The function to create a debounced function from.
- `debounceMs`(`number`): The number of milliseconds to delay.
</Field>

<Field name="options" type="DebounceOptions">
An options object.
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/function/debounce.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
