---
title: "memoize"
description: "Caches function results so it runs faster when called again with the same arguments."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# memoize <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/function/memoize.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
