---
title: "throttle"
description: "Limits a function to be executed at most once per specified time interval."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# throttle <Badge color="#c85a3e">es-toolkit</Badge>
...
<Field name="throttleMs" type="number" required>
The time interval (in milliseconds) to throttle execution.
</Field>

<Field name="options" type="ThrottleOptions">
Additional options.
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/function/throttle.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
