---
title: "rest"
description: "Creates a new function that bundles parameters from a specific index into an array and passes them to the function."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# rest <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/function/rest.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
