---
title: "identity"
description: "Returns the input value as is."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# identity <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/function/identity.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
