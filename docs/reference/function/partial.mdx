---
title: "partial"
description: "Creates a new function with some arguments pre-applied."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# partial <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/function/partial.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
