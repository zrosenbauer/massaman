---
title: "ary"
description: "Creates a new function that limits the number of arguments a function can accept."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# ary <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/function/ary.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
