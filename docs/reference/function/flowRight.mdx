---
title: "flowRight"
description: "Creates a new function that executes the given functions in sequence from right to left."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# flowRight <Badge color="#c85a3e">es-toolkit</Badge>
...
<Field name="funcs" type="(...args: any[]) =&gt; any" required>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/function/flowRight.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
