---
title: "retry"
description: "Retries a Promise-returning function until it succeeds."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# retry <Badge color="#c85a3e">es-toolkit</Badge>
...
<Field name="func" type="() =&gt; Promise&lt;T&gt;" required>
The asynchronous function to retry.
</Field>

<Field name="options" type="number | RetryOptions">
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/function/retry.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
