---
title: "isEqualWith"
description: "Checks if two values are equal using a custom comparison function."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# isEqualWith <Badge color="#c85a3e">es-toolkit</Badge>
...
<Field name="areValuesEqual" type="(x: any, y: any, property?: PropertyKey, xParent?: any, yParent?: any, stack?: Map&lt;any, any&gt;) =&gt; boolean | void" required>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/predicate/isEqualWith.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
