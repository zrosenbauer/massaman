---
title: "isSet"
description: "Checks if a given value is a Set instance."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# isSet <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/predicate/isSet.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
