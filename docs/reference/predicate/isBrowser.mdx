---
title: "isBrowser"
description: "Checks if the current execution environment is a browser."
---

import { Badge } from '@ciderpress/ui/theme'

# isBrowser <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/predicate/isBrowser.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
