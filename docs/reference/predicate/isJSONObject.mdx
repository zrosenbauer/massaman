---
title: "isJSONObject"
description: "Checks if a value is a valid JSON object."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# isJSONObject <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/predicate/isJSONObject.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
