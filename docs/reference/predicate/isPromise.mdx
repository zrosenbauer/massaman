---
title: "isPromise"
description: "Checks if a given value is a Promise instance."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# isPromise <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/predicate/isPromise.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
