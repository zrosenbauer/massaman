---
title: "isRegExp"
description: "Checks if a given value is a RegExp instance."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# isRegExp <Badge color="#c85a3e">es-toolkit</Badge>
...
The value to check if it's a RegExp instance.
</Field>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/predicate/isRegExp.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
