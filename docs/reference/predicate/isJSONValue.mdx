---
title: "isJSONValue"
description: "Checks if a value is a valid JSON value."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# isJSONValue <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/predicate/isJSONValue.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
