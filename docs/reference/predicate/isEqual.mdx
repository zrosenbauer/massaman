---
title: "isEqual"
description: "Performs a deep comparison to check if two values are equal."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# isEqual <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/predicate/isEqual.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
