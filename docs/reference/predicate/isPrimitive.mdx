---
title: "isPrimitive"
description: "Checks if a given value is a JavaScript primitive."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# isPrimitive <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/predicate/isPrimitive.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
