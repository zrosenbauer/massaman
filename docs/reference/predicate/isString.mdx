---
title: "isString"
description: "Checks if a given value is a string."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# isString <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/predicate/isString.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
