---
title: "toKebabCaseKeys"
description: "Returns a new object with all keys in objects and arrays converted to kebab-case."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# toKebabCaseKeys <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/object/toKebabCaseKeys.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
