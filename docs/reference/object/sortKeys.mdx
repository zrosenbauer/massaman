---
title: "sortKeys"
description: "Creates a new object with the keys sorted."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# sortKeys <Badge color="#c85a3e">es-toolkit</Badge>
...
<Field name="compareKeys" type="(a: string, b: string) =&gt; number">
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/object/sortKeys.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
