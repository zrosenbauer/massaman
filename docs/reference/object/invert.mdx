---
title: "invert"
description: "Creates a new object with keys and values swapped."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# invert <Badge color="#c85a3e">es-toolkit</Badge>
...
<Field name="obj" type="Record&lt;K, V&gt;" required>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/object/invert.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
