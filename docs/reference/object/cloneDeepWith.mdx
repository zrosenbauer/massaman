---
title: "cloneDeepWith"
description: "Deeply clones the given value with a custom cloning function."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# cloneDeepWith <Badge color="#c85a3e">es-toolkit</Badge>
...
<Field name="cloneValue" type="(value: any, key: PropertyKey | undefined, obj: T, stack: Map&lt;any, any&gt;) =&gt; any" required>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/object/cloneDeepWith.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
