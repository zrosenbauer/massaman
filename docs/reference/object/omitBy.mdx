---
title: "omitBy"
description: "Returns a new object containing only the properties that do not satisfy the condition function."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# omitBy <Badge color="#c85a3e">es-toolkit</Badge>
...
<Field name="shouldOmit" type="(value: T[keyof T], key: keyof T) =&gt; boolean" required>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/object/omitBy.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
