---
title: "toConstantCaseKeys"
description: "Returns a new object with all keys in objects and arrays converted to CONSTANTCASE."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# toConstantCaseKeys <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/object/toConstantCaseKeys.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
