---
title: "toCamelCaseKeys"
description: "Returns a new object with all keys in objects and arrays converted to camelCase."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# toCamelCaseKeys <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/object/toCamelCaseKeys.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
