---
title: "takeWhile"
description: "Creates a new array by taking elements from the beginning of the array while the condition function returns true."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# takeWhile <Badge color="#c85a3e">es-toolkit</Badge>
...
<Field name="predicate" type="(element: T, index: number, array: T[]) =&gt; boolean" required>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/array/takeWhile.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
