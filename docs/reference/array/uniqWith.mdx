---
title: "uniqWith"
description: "Returns a new array with duplicate elements removed using a comparison function."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# uniqWith <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/array/uniqWith.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
