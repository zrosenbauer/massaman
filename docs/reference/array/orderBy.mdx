---
title: "orderBy"
description: "Returns a new array sorted by multiple criteria and sort directions."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# orderBy <Badge color="#c85a3e">es-toolkit</Badge>
...
<Field name="criteria" type="ReadonlyArray&lt;((item: T) =&gt; unknown) | keyof T&gt;" required>
The criteria to sort by. You can use property names of objects or functions that return values.
</Field>

<Field name="orders" type="ReadonlyArray&lt;'asc' | 'desc'&gt;" required>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/array/orderBy.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
