---
title: "groupBy"
description: "Returns a new object with array elements grouped according to a key-generating function."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# groupBy <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/array/groupBy.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
