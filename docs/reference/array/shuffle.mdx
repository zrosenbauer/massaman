---
title: "shuffle"
description: "Returns a new array with the elements randomly shuffled."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# shuffle <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/array/shuffle.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
