---
title: "keyBy"
description: "Returns a new object with array elements converted to key-value pairs using a key-generating function."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# keyBy <Badge color="#c85a3e">es-toolkit</Badge>
...
<Field name="getKeyFromItem" type="(item: T, index: number, array: T[]) =&gt; K" required>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/array/keyBy.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
