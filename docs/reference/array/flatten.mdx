---
title: "flatten"
description: "Returns a new array that is flattened to the specified depth."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# flatten <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/array/flatten.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
