---
title: "unzipWith"
description: "Unpacks grouped arrays and applies a transformation function to return a new array."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# unzipWith <Badge color="#c85a3e">es-toolkit</Badge>
...
<Field name="target" type="readonly T[][]" required>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/array/unzipWith.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
