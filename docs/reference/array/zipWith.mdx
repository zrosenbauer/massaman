---
title: "zipWith"
description: "Creates a new array by combining multiple arrays using a custom function."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# zipWith <Badge color="#c85a3e">es-toolkit</Badge>
...
<Field name="combine" type="(...items: [...T[], number]) =&gt; R" required>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/array/zipWith.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
