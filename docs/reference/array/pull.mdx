---
title: "pull"
description: "Removes all specified values from an array."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# pull <Badge color="#c85a3e">es-toolkit</Badge>
...
<Field name="valuesToRemove" type="readonly unknown[]" required>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/array/pull.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
