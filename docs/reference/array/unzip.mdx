---
title: "unzip"
description: "Unpacks grouped arrays and creates new arrays by gathering elements at the same position."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# unzip <Badge color="#c85a3e">es-toolkit</Badge>
...
<Field name="zipped" type="ReadonlyArray&lt;[...T]&gt;" required>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/array/unzip.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
