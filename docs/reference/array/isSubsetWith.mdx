---
title: "isSubsetWith"
description: "Checks if one array is a subset of another array based on a custom comparison function."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# isSubsetWith <Badge color="#c85a3e">es-toolkit</Badge>
...
<Field name="areItemsEqual" type="(x: T, y: T) =&gt; boolean" required>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/array/isSubsetWith.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
