---
title: "unionWith"
description: "Creates a new array containing unique elements from two arrays based on a custom equality function."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# unionWith <Badge color="#c85a3e">es-toolkit</Badge>
...
<Field name="areItemsEqual" type="(item1: T, item2: T) =&gt; boolean" required>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/array/unionWith.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
