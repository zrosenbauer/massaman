---
title: "pullAt"
description: "Removes elements at specified indices from an array and returns the removed elements."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# pullAt <Badge color="#c85a3e">es-toolkit</Badge>
...
<Field name="indicesToRemove" type="readonly number[]" required>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/array/pullAt.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
