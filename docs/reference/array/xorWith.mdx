---
title: "xorWith"
description: "Creates a new array with elements that exist in only one of two arrays using a given comparison function."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# xorWith <Badge color="#c85a3e">es-toolkit</Badge>
...
<Field name="areElementsEqual" type="(item1: T, item2: T) =&gt; boolean" required>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/array/xorWith.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
