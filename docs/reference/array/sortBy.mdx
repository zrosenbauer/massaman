---
title: "sortBy"
description: "Returns a new array sorted in ascending order by the given criteria."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# sortBy <Badge color="#c85a3e">es-toolkit</Badge>
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/array/sortBy.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
