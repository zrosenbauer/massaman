---
title: "windowed"
description: "Returns a new array containing snapshots of each window as a window of specified size slides regularly along the array."
---

import { Badge, Field } from '@ciderpress/ui/theme'

# windowed <Badge color="#c85a3e">es-toolkit</Badge>
...
<Field name="options.partialWindows" type="boolean">
...
Re-exported verbatim from [`es-toolkit`](https://es-toolkit.dev/reference/array/windowed.html). Implementation, edge cases, and performance behavior are owned upstream. This page mirrors the documentation at the pinned version; the linked source is authoritative.
